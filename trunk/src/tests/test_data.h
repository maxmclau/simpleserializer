...
static const unsigned char numeric_data[] = {
    ...
    0xC2,                            // FALSE
    0xC3,                            // TRUE
    0xCA, 0x44, 0x9A, 0x50, 0x00,    // FLOAT 1234.5
    0xCA, 0xC4, 0x9A, 0x50, 0x00,    // FLOAT -1234.5
#ifdef SUPPORT_64BIT_VALUE
    0xCB, 0x40, 0x93, 0x48, 0x7E,    // DOUBLE 1234.123456
    0x6B, 0x3F, 0xE9, 0xFB,
    0xCB, 0xC0, 0x93, 0x48, 0x7E,    // DOUBLE -1234.123456
    0x6B, 0x3F, 0xE9, 0xFB,
#endif
    0x00,                            // FIXUINT 0
    0x7F,                            // FIXUINT 127
